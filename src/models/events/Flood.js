export default class Flood {
  constructor() {
    ...
    this.floods = [
      ...
      {
        description:
          "Сильнейшее цунами стало причиной серьезных разрушений в прибрежных городах ряда стран Западной Африки (Сенегал, Гамбия, Гвинея-Бисау, Гвинея, Сьерра-Леоне, Либерия).",
