export default class Flood {
  constructor() {
    ...
    this.floods = [
      ...
      {
        description:
          "Сильнейшее цунами принесло колосальные разрушения на прибрежные города Западной Африки (Сенегал, Гамбия, Гвинея-Бисау, Гвинея, Сьерра-Леоне, Либерия).",
        countries: ["SN", "GM", "GN", "GW", "SL", "LR"],
      },
      {
        description:
          "Сильное землятресение в Индийском океане вызвало разрушительно цунами. Ряд стран Юго-восточной Азии нуждаются в помощи (Шри-Ланка, Мьянма, Тайланд, Индонезия).",
