export default class OilSpill {
  constructor() {
    this.name = "oil-spill";
    this.description =
      "У побережья Норвегии произошла авария на нефтяной платформе компании Статоил. Теплое Норвежское океаническое течение быстро разносит миллионы галлонов сырой нефти вдоль всего северного побережья Европы.";
    this.active = false;
