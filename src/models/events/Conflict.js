export default class Conflict {
  constructor() {
    ...
    this.conflicts = [
      ...
      {
        description:
          "Террористические организиации Аль-Каида и Аль-Мурабитун проявляют новую активность в Западной Африке. Население западной части Нигера, Буркина—Фасо, Кот—д'Ивуара и Мали подвергается постоянным нападениям террористов.",
